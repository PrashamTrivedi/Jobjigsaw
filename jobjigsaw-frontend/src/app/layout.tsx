        ...
        <ThemeProvider defaultTheme="system" storageKey="jobjigsaw-theme">
          <ToastProvider>
            ...
            <div className='flex flex-col min-h-screen bg-background text-foreground'>
              <nav className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-primary-foreground px-6 py-2 shadow-lg border-b border-border/20" role="navigation" aria-label="Main navigation">
                <NavLinks />
              </nav>
